...
{
    /// <summary>
    /// Класс Password инкапсулирует пароль пользователя.
    /// </summary>
    public sealed class PasswordUtility
    {
        ...
        public PasswordUtility(byte[] salt, byte[] hash)
        {
        ...
        public PasswordUtility(string salt, string hash)
        {
        ...
        public PasswordUtility(char[] clearText)
        {
